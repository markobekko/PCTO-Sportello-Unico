    ...
    if($risultatoCandidato -> num_rows > 0){
        ...
        while($row=$risultatoCandidato -> fetch_assoc()){
            if($row["archiviato"] == "Si"){
                ...
                echo "<tr>";
                echo "<td>". "<input name='cognome' data-label='cognome' id='cognome' type='text' value='". $row["cognome"] ."' readonly='readonly'>"."</td>";
                echo "<td>". "<input name='nome' data-label='nome' id='nome' type='text' value='". $row["nome"] ."' readonly='readonly'>" ."</td>";
                echo "<td>". "<input name='codice_fiscale' data-label='codice fiscale' id='codice_fiscale' type='text' readonly='readonly' value='". $row["codice_fiscale"] ."' readonly='readonly'>" ."</td>";
                echo "<td>". "<input name='email' id='email' data-label='email' type='email' value='". $row["email"] ."' readonly='readonly'>" ."</td>";
                ...
                echo "<td>";
                        echo "<select name='esito' data-label='esito esame' id='esito' disabled>";
