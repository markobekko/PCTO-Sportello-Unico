<?php
	...
	if(isset($_POST['cognome']) && isset($_POST['nome']) && isset($_POST['codice_fiscale']) && isset($_POST['email']) && isset($_POST['data_esame']) && isset($_POST['sede_esame'])){
        ...
        echo "Cognome: " . $cognome . " Nome: " . $nome . " CF:" . $codice_fiscale . " Email: " . $email . " Data Esame: " . $data_esame . " Sede Esame: " . $sede_esame;
        ...
        //Aggiungo l'utente
        $aggiunta = $pdo -> prepare("INSERT INTO users (cognome, nome, codice_fiscale, email, data_esame, sede_esame, spedito_utente, esito_esame ) values (?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        $aggiunta -> bindValue(7, 'NULL');
        $aggiunta -> execute();
        echo "La persona {nome,congome} è stata aggiunta";
	}
    else{
